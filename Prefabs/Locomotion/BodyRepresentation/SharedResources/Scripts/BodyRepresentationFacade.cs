namespace VRTK.Prefabs.Locomotion.BodyRepresentation
{
    ...
    public class BodyRepresentationFacade : MonoBehaviour
    {
        ...
        {
            IgnoredInteractors.Added.AddListener(OnIgnoredInteractorsChanged);
            IgnoredInteractors.Removed.AddListener(OnIgnoredInteractorsChanged);
        }

        protected virtual void OnDisable()
        {
            IgnoredInteractors.Added.RemoveListener(OnIgnoredInteractorsChanged);
            IgnoredInteractors.Removed.RemoveListener(OnIgnoredInteractorsChanged);
        }

        protected virtual void OnIgnoredInteractorsChanged(InteractorFacade interactor)
        {
            Processor.ConfigureIgnoreInteractorsCollisions();
        }
