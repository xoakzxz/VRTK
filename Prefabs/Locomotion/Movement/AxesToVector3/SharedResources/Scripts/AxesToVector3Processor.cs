namespace VRTK.Prefabs.Locomotion.Movement.AxesToVector3
{
    ...
    public class AxesToVector3Processor : MonoBehaviour, IProcessable
    {
        ...
        {
            SpeedMultiplier.SetComponentX(Facade.LateralSpeedMultiplier, 1);
            SpeedMultiplier.SetComponentZ(Facade.LongitudinalSpeedMultiplier, 1);
            SpeedMultiplier.Collection.CurrentIndex = 0;
        }
